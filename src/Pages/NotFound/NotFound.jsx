...
function NotFound({ code, title, description }) {
  return (
    <main>
      <section
      ...
      >
        ...
        <div
          className={`${SECTION_CONTAINER} relative py-16 sm:py-20 lg:py-28`}
        >
          <div className="mx-auto max-w-3xl text-center opacity-0 animate-fade-in-up">
            ...
            <p className="mt-6 text-base leading-relaxed text-slate-300 sm:text-lg">
              {description ||
                "The page you are looking for may have been moved, renamed, or no longer exists. Let us help you get back on track."}
            </p>
      ...
      <SectionShell className="bg-white">
        ...
        >
          {QUICK_LINKS.map((link) => (
            <li key={link.to}>
              <CtaLink to={link.to} variant="secondary" className="w-full">
                {link.label}
              </CtaLink>
            </li>
          ))}
