  ...
  return (
    <section className="bg-blue-50 py-10">
      <div className="text-center mb-8">
        <h3 className="text-green-600 text-base font-medium">ZEF News</h3>
        <h2 className="text-4xl font-bold text-blue-900 mt-2">Latest Updates on Youth &amp; Community Impact</h2>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 px-4">
        ...
        <div className="bg-white shadow-md overflow-hidden group">
          ...
          <div className="p-6">
            <h4 className="mt-4 text-2xl font-semibold text-gray-800 transition-colors duration-300 group-hover:text-green-600">Youth Innovation Spotlight: Building Skills for Tomorrow</h4>
            <p className="mt-2 text-base text-gray-500">ZEF Programs</p>
          </div>
        </div>
