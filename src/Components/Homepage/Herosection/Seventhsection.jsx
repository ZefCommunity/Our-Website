  ...
  >
    <div className="container mx-auto px-4 flex flex-col items-center text-center space-y-4">
      ...
      <h2 className="text-2xl md:text-4xl font-bold">
        Empower Communities Through Innovation and Service
      </h2>
      <button type="button" className="relative overflow-hidden bg-white text-blue-900 font-semibold py-2 px-6 shadow group">
